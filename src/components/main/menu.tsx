...
export default function NavMenu({ actualpathEn, actualpathEs } : { actualpathEn: string; actualpathEs: string }) {
    ...
    return (
        <div className="fixed right-[16px] bottom-[16px]">
            <div className="relative">
                <button 
                    className="bg-zinc-300 dark:bg-zinc-600 shadow px-3 py-2 rounded-sm"
                ...
                <TranslateButton ref={translateButtonRef} urlEs={actualpathEs} urlEn={actualpathEn} />
            </div>
        </div>
    );
}